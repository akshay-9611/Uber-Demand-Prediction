...
import dagshub
dagshub.init(repo_owner='akshua363', repo_name='Uber-Demand-Prediction', mlflow=True)

# set the mlflow tracking uri
mlflow.set_tracking_uri("https://dagshub.com/akshua363/Uber-Demand-Prediction.mlflow")
